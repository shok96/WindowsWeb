...
function AccordionSummary(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { role: 'heading', "aria-level": ariaLevel, className: (0, constants_2.accordionSummaryBlock)({ size, arrow_position: arrowPosition }), children: (0, jsx_runtime_1.jsx)(Disclosure_1.Disclosure.Summary, { qa: qa, children: (disclosureProps, defaultSummary) => {
                const enhancedProps = {
                    ...disclosureProps,
                    onKeyDown: (e) => {
                        handleKeyDown(e);
