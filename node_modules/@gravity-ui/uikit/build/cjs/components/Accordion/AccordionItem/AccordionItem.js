...
function prepareChildren(children, qa) {
    ...
    if (!summary) {
        summary = ((0, jsx_runtime_1.jsx)(AccordionSummary_1.AccordionSummary, { children: (props) => ((0, jsx_runtime_1.jsx)(DisclosureSummary_1.DefaultDisclosureSummary, { ...props, qa: summaryQa, className: constants_1.accordionSummaryTriggerBlock })) }));
    }
