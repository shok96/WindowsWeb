...
export function AccordionSummary(props) {
    ...
    return (_jsx("div", { role: 'heading', "aria-level": ariaLevel, className: accordionSummaryBlock({ size, arrow_position: arrowPosition }), children: _jsx(Disclosure.Summary, { qa: qa, children: (disclosureProps, defaultSummary) => {
                const enhancedProps = {
                    ...disclosureProps,
                    onKeyDown: (e) => {
                        handleKeyDown(e);
