...
import { AccordionSummary, isAccordionSummaryComponent } from "../AccordionSummary/AccordionSummary.js";
...
function prepareChildren(children, qa) {
    ...
    if (!summary) {
        summary = (_jsx(AccordionSummary, { children: (props) => (_jsx(DefaultDisclosureSummary, { ...props, qa: summaryQa, className: accordionSummaryTriggerBlock })) }));
    }
