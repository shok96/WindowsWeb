...
export declare const DropdownMenuNavigationContextProvider: ({ anchorRef, children, disabled, }: DropdownMenuNavigationContextProviderProps) => import("react/jsx-runtime").JSX.Element;
