...
import { EditorLanguageWorks, IWorkerDefinition } from './languageWork.js';
/**
 * Return a resolved path for a given Monaco file.
 */
export declare function resolveMonacoPath(filePath: string): string;
export declare function getWorks(options: IMonacoEditorOpts): IWorkerDefinition[] | undefined;
